...
| Subgraph | Image |
|---|---|
| Online CICS Programs | ![Call Graph Online](docs/screenshots/mermaid_call_graph_online.png) |
| Batch Programs | ![Call Graph Batch](docs/screenshots/mermaid_call_graph_batch.png) |

### 2. Transaction Flow

![Transaction Flow](docs/screenshots/mermaid_transaction_flow.png)

### 3. JCL Job Chain

![JCL Job Chain](docs/screenshots/mermaid_jcl_chain.png)

### 4. File I/O Graph

![File IO Graph](docs/screenshots/mermaid_file_io.png)
